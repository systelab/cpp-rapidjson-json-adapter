...
> "$VSINSTALLPATH/devenv.com" RapidJSONAdapter.sln /build "Release" /PROJECT "RapidJSONAdapter"
```
...
> cmake .. -G "Visual Studio 16 2019" -A x64
> "$VSINSTALLPATH/devenv.com" RapidJSONAdapter.sln /build "Debug" /PROJECT "RapidJSONAdapter"
```
