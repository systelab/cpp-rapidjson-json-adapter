...
JSONDocument::JSONDocument(std::unique_ptr<rapidjson::Document> document)
    : m_document(std::move(document)),
      m_rootValue(std::make_unique<JSONValue>(*this, *m_document,
                                              m_document->GetAllocator())),
      m_freeValues() {}

JSONDocument::~JSONDocument() {}

IJSONValue& JSONDocument::getRootValue() { return *m_rootValue; }

const IJSONValue& JSONDocument::getRootValue() const { return *m_rootValue; }
...
std::unique_ptr<rapidjson::Value> JSONDocument::removeFreeValue(
